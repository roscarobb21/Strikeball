...
class OrganizamCard extends React.Component{
    ...
    render(){
        ...
        return(<div style={{backgroundColor:'#EDEDED'}}>
            <Row>
                <Col md="4"></Col>
                <Col  md="4"><p id="merita-text">{this.state.lang.organize.header}</p></Col>
                <Col  md="4"></Col>
            </Row>
            <Row>
                <Col sm="0" md="2"></Col>
            ...
            <Row style={{marginTop:'4vh'}}>
                ...
                <Button outline size="lg" style={{ borderRadius: 50 , padding:'30px'}}>{this.state.lang.organize.button}</Button>
